    ...
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(resolve, reject) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            if (!(!data.email || !data.doctorId || !data.date || !data.timeType || !data.selectedGender || !data.u_rfid)) {
              _context.next = 5;
              break;
            }
            resolve({
...
var postRfid = function postRfid(rfid) {
  return new Promise( /*#__PURE__*/function () {
        ...
        while (1) switch (_context2.prev = _context2.next) {
          ...
          case 5:
            ...
            return _index["default"].booking.findOne({
              ...
              attributes: {
                exclude: ["id", "statusId", "doctorId", "rfid", "patientId", "date", "timeType", "token", "createdAt", "updatedAt"]
              },
              include: [{
