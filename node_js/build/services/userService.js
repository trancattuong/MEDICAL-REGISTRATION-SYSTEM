...
var saltRounds = _bcryptjs["default"].genSaltSync(10);
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _bcryptjs["default"].hashSync(password, saltRounds);
          case 3:
...
var handleUserLogin = function handleUserLogin(Name, u_rfid, password) {
  return new Promise( /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(resolve, reject) {
      var userData, isExist, _db$User$findOne, user, check;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            userData = {};
            isExist = checkUserName(u_rfid);
            if (!isExist) {
              _context2.next = 18;
              break;
            }
            _context2.next = 6;
            return _index["default"].User.findOne((_db$User$findOne = {
              attributes: ['id', 'Name', 'role', 'password', 'u_rfid'],
              where: {
                u_rfid: u_rfid
              }
            }, _defineProperty(_db$User$findOne, "where", {
              Name: Name
            }), _defineProperty(_db$User$findOne, "raw", true), _db$User$findOne));
          case 6:
            user = _context2.sent;
            if (!user) {
              _context2.next = 14;
...
var checkUserName = function checkUserName(userrfid, username) {
  return new Promise( /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee5$(_context5) {
        while (1) switch (_context5.prev = _context5.next) {
          case 0:
            _context5.prev = 0;
            _context5.next = 3;
            return checkUserName(data.u_rfid);
          case 3:
